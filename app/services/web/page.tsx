...
const monthlyPlans = [
  {
    name: "1ページプラン", initial: "無料", price: "5,000", contract: "最低契約期間なし", recommended: false,
    badge: "初期費用 ¥0",
...
const faqs = [
  ...
  { q: "月額プランはいつでも解約できますか？", a: "1ページプランは最低契約期間がなく、いつでも解約いただけます。エントリープランは6ヶ月、ライトプランは6ヶ月、スタンダードプランは3ヶ月の最低契約期間があります。期間内の解約には違約金（¥19,800）が発生します。" },
